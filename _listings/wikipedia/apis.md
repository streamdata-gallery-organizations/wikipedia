...
- name: Wikipedia
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/wikipedia/master/_listings/wikipedia/transform-word-from-from-lang-to-to-lang-word-provider-get.md
x-common:
- type: x-base
